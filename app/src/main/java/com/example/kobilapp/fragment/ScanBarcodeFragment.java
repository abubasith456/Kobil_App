...
import com.example.kobilapp.viewModel.ScanBarcodeViewModel;

public class ScanBarcodeFragment extends Fragment {

    private ScanBarcodeViewModel mViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(ScanBarcodeViewModel.class);
